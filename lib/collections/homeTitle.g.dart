...
extension GetTitleCollection on Isar {
  IsarCollection<Title> get titles => this.collection();
}
...
Id _titleGetId(Title object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _titleGetLinks(Title object) {
  return [];
}

void _titleAttach(IsarCollection<dynamic> col, Id id, Title object) {
  object.id = id;
}
...
extension TitleQueryWhere on QueryBuilder<Title, Title, QWhereClause> {
  QueryBuilder<Title, Title, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Title, Title, QAfterWhereClause> idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Title, Title, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Title, Title, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension TitleQueryFilter on QueryBuilder<Title, Title, QFilterCondition> {
  QueryBuilder<Title, Title, QAfterFilterCondition> idEqualTo(Id value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> titleEqualTo(
    String value, {
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> titleGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> titleLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> titleBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> titleStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> titleEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> titleContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> titleMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'title',
        value: '',
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> titleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'title',
        value: '',
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> typeIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> typeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'type',
        value: '',
  ...
  QueryBuilder<Title, Title, QAfterFilterCondition> typeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'type',
        value: '',
...
extension TitleQuerySortBy on QueryBuilder<Title, Title, QSortBy> {
  QueryBuilder<Title, Title, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<Title, Title, QAfterSortBy> sortByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TitleQuerySortThenBy on QueryBuilder<Title, Title, QSortThenBy> {
  ...
  QueryBuilder<Title, Title, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<Title, Title, QAfterSortBy> thenByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }
...
extension TitleQueryWhereDistinct on QueryBuilder<Title, Title, QDistinct> {
  QueryBuilder<Title, Title, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TitleQueryProperty on QueryBuilder<Title, Title, QQueryProperty> {
  ...
  QueryBuilder<Title, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
